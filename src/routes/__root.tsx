...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aurum — AI Financial Portfolio for Vietnam" },
      { name: "twitter:title", content: "Aurum — AI Financial Portfolio for Vietnam" },
      { property: "og:description", content: "Premium AI-powered personal finance and investment portfolio management for the Vietnamese market." },
      { name: "twitter:description", content: "Premium AI-powered personal finance and investment portfolio management for the Vietnamese market." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/1fbdfcf4-603f-4fb0-aea3-3fee7bce6fab" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/1fbdfcf4-603f-4fb0-aea3-3fee7bce6fab" },
